...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($students as $s) { Student::create($s); }
        ...
        foreach ($faculty as $f) { Faculty::create($f); }
        ...
        foreach ($courses as $c) { Course::create($c); }
        ...
        foreach ($sections as $s) { Section::create($s); }
        ...
        foreach ($labs as $l) { Laboratory::create($l); }
        ...
        foreach ($syllabi as $s) { Syllabus::create($s); }
        ...
        foreach ($lessons as $l) { Lesson::create($l); }
        ...
        foreach ($curricula as $c) { Curriculum::create($c); }
        ...
        foreach ($assignments as $a) { FacultyAssignment::create($a); }
    }
}
