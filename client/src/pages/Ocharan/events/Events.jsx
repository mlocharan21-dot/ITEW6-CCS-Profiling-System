...
import { DataTable, Modal, FormInput, PlusIcon, CalendarIcon, ClockIcon, UserIcon, MapPinIcon } from '../../../components';

const Events = () => {
  const { events, fetchEvents, addEvent, updateEvent, deleteEvent } = useApp();
          ...
          {filteredEvents.length === 0 && (
            <div className="card">
              <div className="empty-state">
                <div className="empty-state-icon"><CalendarIcon size={40} stroke="#94a3b8" /></div>
