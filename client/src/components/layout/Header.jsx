...
import { UserIcon, TeacherIcon, BookIcon, CalendarIcon } from '../common/Icons';
              ...
              {searchResults.map((result, index) => (
                ...
                >
                  <div className={`search-result-icon ${result.type}`}>
                    {result.type === 'student' && <UserIcon size={16} />}
                    {result.type === 'faculty' && <TeacherIcon size={16} />}
                    {result.type === 'course' && <BookIcon size={16} />}
                    {result.type === 'event' && <CalendarIcon size={16} />}
                  </div>
